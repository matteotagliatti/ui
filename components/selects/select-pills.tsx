...
export default function SelectPillsDemo() {
  const [selectedPills, setSelectedPills] = useState<string[]>([]);
  const data = [
    { id: "1", value: "1", name: "Pill 1" },
    { id: "2", value: "2", name: "Pill 2" },
    { id: "3", value: "3", name: "Pill 3" },
    { id: "4", value: "4", name: "Pill 4" },
    { id: "5", value: "5", name: "Pill 5" },
    { id: "6", value: "6", name: "Pill 6" },
  ];
  return (
    <div className="space-y-2">
      <Label>Select Pills</Label>
      <SelectPills
        data={data}
        value={selectedPills}
        onValueChange={setSelectedPills}
      />
    </div>
  );
}
