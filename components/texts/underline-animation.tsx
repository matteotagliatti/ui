...
import cn from "clsx";
import { motion, useAnimationControls, Transition } from "motion/react";
...
export default function UnderlineAnimationDemo() {
  return (
    <div className="flex justify-center items-center">
      <GoesOutComesInUnderline label="si va a letto" direction="right" />
    </div>
  );
}
